...
public class FacebookUtils {
    ...
    static AppPokerActivity m_activity;
    ...
    public static void init(AppPokerActivity activity) {
        m_activity = activity;
        initSDK(activity);
    }
     ...
     * 初始化SDK
     */
    public static void initSDK(AppPokerActivity activity)
    {
...
//                        Utils.reportShareResult("error");
    ...
    public static void FaceBookLogin() {
        ...
        LoginManager.getInstance().logInWithReadPermissions((AppPokerActivity) m_activity.getContext(), Arrays.asList("public_profile"));
    }
